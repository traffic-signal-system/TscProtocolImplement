...
public class GbtDefine {
    ...
    /**插入取消上报的返回消息格式**/
    public static byte[] REPORT_TSC_STATUS_CANCEL_RETURN = {(byte)0x85,(byte)0xF7,0x00,(byte)0x01};
    ...
    //黄闪
    public static byte[] CTRL_FLASH = { SET_REQUEST_RESPONSE, (byte)0xB6, 0x0, (byte)0xfe };
    //全红
    public static byte[] CTRL_RED = { SET_REQUEST_RESPONSE, (byte)0xB6, 0x0, (byte)0xfd };
    //熄灯
    public static byte[] CTRL_OFF = { SET_REQUEST_RESPONSE, (byte)0xB6, 0x0, (byte)0xff };
    //校时
    ...
    //南
    public static byte SOUTH_TURN_AROUND = (byte)0x80;  //调头
    public static byte SOUTH_LEFT = (byte)0x81;
    public static byte SOUTH_STRAIGHT = (byte)0x82;
    public static byte SOUTH_LEFT_STRAIGHT = (byte)0x83;
    public static byte SOUTH_RIGHT = (byte)0x84;
    public static byte SOUTH_OTHER = (byte)0x85;
    public static byte SOUTH_RIGHT_STRAIGHT = (byte)0x86;
    public static byte SOUTH_LEFT_STRAIGHT_RIGHT = (byte)0x87;
    public static byte SOUTH_PEDESTRAIN_ONE = (byte)0x88;
    public static byte SOUTH_PEDESTRAIN_TWO = (byte)0x98;
    //西南
    public static byte WEST_SOUTH_TURN_AROUND = (byte)0xa0;  //调头
    public static byte WEST_SOUTH_LEFT = (byte)0xa1;
    public static byte WEST_SOUTH_STRAIGHT = (byte)0xa2;
    public static byte WEST_SOUTH_LEFT_STRAIGHT =(byte) 0xa3;
    public static byte WEST_SOUTH_RIGHT = (byte)0xa4;
    public static byte WEST_SOUTH_OTHER = (byte)0xa5;
    public static byte WEST_SOUTH_RIGHT_STRAIGHT = (byte)0xa6;
    public static byte WEST_SOUTH_LEFT_STRAIGHT_RIGHT =(byte) 0xa7;
    public static byte WEST_SOUTH_PEDESTRAIN_ONE = (byte)0xa8;
    public static byte WEST_SOUTH_PEDESTRAIN_TWO = (byte)0xb8;
    //西方
    public static byte WEST_TURN_AROUND =(byte) 0xc0;  //调头
    public static byte WEST_LEFT = (byte)0xc1;
    public static byte WEST_STRAIGHT = (byte)0xc2;
    public static byte WEST_LEFT_STRAIGHT = (byte)0xc3;
    public static byte WEST_RIGHT = (byte)0xc4;
    public static byte WEST_OTHER =(byte) 0xc5;
    public static byte WEST_RIGHT_STRAIGHT = (byte)0xc6;
    public static byte WEST_LEFT_STRAIGHT_RIGHT =(byte) 0xc7;
    public static byte WEST_PEDESTRAIN_ONE =(byte) 0xc8;
    public static byte WEST_PEDESTRAIN_TWO = (byte)0xd8;
    //西北
    public static byte WEST_NORTH_TURN_AROUND = (byte)0xe0;  //调头
    public static byte WEST_NORTH_LEFT =(byte) 0xe1;
    public static byte WEST_NORTH_STRAIGHT =(byte) 0xe2;
    public static byte WEST_NORTH_LEFT_STRAIGHT =(byte) 0xe3;
    public static byte WEST_NORTH_RIGHT =(byte) 0xe4;
    public static byte WEST_NORTH_OTHER = (byte)0xe5;
    public static byte WEST_NORTH_RIGHT_STRAIGHT = (byte)0xe6;
    public static byte WEST_NORTH_LEFT_STRAIGHT_RIGHT =(byte) 0xe7;
    public static byte WEST_NORTH_PEDESTRAIN_ONE =(byte) 0xe8;
    public static byte WEST_NORTH_PEDESTRAIN_TWO = (byte)0xf8;
